...
namespace Ruler.Persistence
{
    ...
    {
        public ProdutoPst(string nome, double valor, double valor_dolar) : base(nome, valor, valor_dolar){}
        public ProdutoPst(int id, string nome, double valor, double valor_dolar) : base(id, nome, valor, valor_dolar){}
